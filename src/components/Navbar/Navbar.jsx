...
import {
  ...
  Droplet,
  Menu, // ✅ हे add कर
  X, // ✅ हेही लागेल कारण MobileMenu मध्ये वापरलय
  ChevronRight, // ✅ Submenu साठी
  ChevronLeft, // ✅ Back button साठी
} from "lucide-react";
  ...
  { id: "contact", title: "Contact", path: "/contact", icon: Mail },
  {
    ...
    submenu: [
      ...
      },
      {
        id: "highways",
        title: "Highways",
        path: "/sectors/highways",
        icon: Route,
      },
      {
        id: "utilities",
        title: "Utilities",
        path: "/sectors/utilities",
        icon: Wrench,
      },
      {
        id: "housing",
        title: "Housing Maintenance",
        path: "/sectors/housing-maintenance",
        icon: House,
      },
      { id: "rail", title: "Rail", path: "/sectors/rail", icon: Train },
      {
        id: "property",
        title: "Property",
      ...
      },
      {
        ...
        path: "/sectors/facilities-management",
        icon: Settings,
      },
      {
        id: "environment",
        title: "Environmental Targets",
        path: "/sectors/environmental-targets",
        icon: Leaf,
      },
      {
        id: "sustainability",
        title: "Sustainability Building Design at DHF",
        path: "/sectors/sustainability-building-design",
        icon: Ruler,
      },
      {
        id: "residential",
      ...
      },
      {
        ...
        path: "/sectors/science-technology-pharmacological",
        icon: FlaskRound,
      },
      {
        id: "telecom",
      ...
      { id: "water", title: "Water", path: "/sectors/water", icon: Droplet },
    ],
  },
];
